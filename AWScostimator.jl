...
begin
	bot_slider = @bind 🤖 html"<input type=range min=1 max=10 value=5>"
	#botcount=🤖
	#botstring=repeat("🤖",$(🤖))
	md"""
...
md"""
##### How many missions does one bot run a day?
"""

# ╔═╡ 51603761-406e-4283-a07a-656e472d0b8a
Daily = @bind Daily NumberField(1:8, default=2)

# ╔═╡ 7b30678d-63cd-4df4-8210-7d630eed40cd
md"""
##### How many hours is each average mission?  
"""
...
md"""
	...
	`Facial Recognition & Matching = ` $(@bind facmat html"<input type=checkbox >")
	
	`Mask and PPE Detector = ` $(@bind mskdet html"<input type=checkbox >")
	
	`Facial Recognition & Matching (fully-masked) = ` $(@bind mskfacmat html"<input type=checkbox >")
	
	`Crowding and Distancing detection = ` $(@bind crwdet html"<input type=checkbox >")
	
	`Abandoned Baggage Detection = ` $(@bind bags html"<input type=checkbox >")
	
	`Idle Cars = ` $(@bind cars html"<input type=checkbox >")
...
md"""
**$optioncount** SageMaker modules selected
"""
...
**Per month:\$ $(Daily*AvgMissionTime*7*🤖*optioncount*awsrate*4)**

**Per quarter:\$ $(Daily*AvgMissionTime*7*🤖*optioncount*awsrate*4*3)**

**Per year:\$ $(Daily*AvgMissionTime*7*🤖*optioncount*awsrate*4*3*3)**
...
# ╔═╡ ce1e91f5-99a9-4489-8ad8-dc6d63c55310


# ╔═╡ 58e1d2f6-4259-409c-bc5a-1236eab3d1d5


# ╔═╡ b3d0f7af-963d-48a1-a886-b868a4da312f


# ╔═╡ 4eeb2f0f-6c08-48c3-b904-d946e49a8082


# ╔═╡ f5c5bce5-469b-4b87-aa59-c8f0a63820c6
